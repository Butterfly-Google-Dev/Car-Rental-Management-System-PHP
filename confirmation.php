...
<body>
    ...
    $cus = "SELECT * FROM  user_form ";
    $result7 = $conn->query($cus);


    if (mysqli_num_rows($result7) > 0) {
        while ($row = mysqli_fetch_assoc($result7)) {
            $customer_username = $row["name"];
        }
    }
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-md-10" style="float: none; margin: 0 auto; ">
                    ...
                    <br>
                    <h4> <strong>Contact: </strong> <?php echo "9776321425"; ?></h4>
                    <br>
                </div>
            </div>
